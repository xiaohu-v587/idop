...
public class SendSmsOfPromptJob11Am extends OuartzJob{
	private static final String sm_job = "IdopSendSmsOfPromptJob11Am";
	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try {
			...
			String nowdate=now+"110000";
			String olddate=now+"090000";
