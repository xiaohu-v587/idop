...
<script type="text/javascript">
	...
	function setData(data){
		...
		var id=infos.id;
		toProp = infos.to_claim_prop.replace("%","");
		$G.getbyName("id").setValue(id);
		document.getElementById("toProp").innerHTML= infos.to_claim_prop;
		addtr("1");
	}
	...
	function save(){
    	...
    	var urlStr = "<%=root%>/zxCustDistr/distsave";
