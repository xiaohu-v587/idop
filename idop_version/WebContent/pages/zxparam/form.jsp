...
<body>
	<div class="mini-fit">
				...
				<input name="id" class="mini-hidden" />
					...
					<table style="table-layout:fixed;" width="100%">
						...
						<tr>
							...
							<td align="left">    
								<input id="zdbh" name="key" class="mini-textbox"  emptyText="字典编号" maxlength="18" required="true" />
							</td>
							<td align="right">字典名称：</td>
							<td align="left">    
								<input id="zdmc" name="name" class="mini-textbox" emptyText="字典名称" maxlength="45" required="true" />
							</td>
						</tr>
						<tr>
							<td align="right">属性值：</td>
							<td align="left">    
								<input name="val" class="mini-textbox"  emptyText="属性值"  maxlength="100"  required="true" />
                            </td>
                            <td align="right">备注：</td>
                            <td align="left">    
								<input name="remark" class="mini-textbox"  emptyText="备注"  maxlength="150"   required="true" />
                            </td>
						</tr>
						<tr>
							...
							<td align="right">父级字典：</td>
							<td align="left">
								<input name="pid" class="mini-combobox" textfield="name" valuefield="id" emptyText="请选择..."
									url="<%=root%>/zxparam/getCombox" showNullItem="true" nullItemText="请选择..." onValueChanged="ctrlOkBtn1()"/>
							</td>
						</tr>    
					</table>
				</div>
     ...
     <div class="mini-toolbar" style="text-align: center;padding-top: 10px;padding-bottom: 10px;margin-bottom: -5px;" 
		...
		<a id="btnOk" class="mini-button" iconCls="icon-ok" onclick="onOk()" enabled="false" style="margin-right: 20px;">确定</a>
...
<script type="text/javascript">
	...
	function setData(data) {
		...
		if (data.pageType == "edit") {
			...
			$G.postByAjax({key:data.id},"<%=root%>/zxparam/getDetail",ajaxConf);
		}else{
