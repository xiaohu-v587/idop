...
<body>
		...
		<form id="dataform1" method="post">
			...
			<fieldset style="border: solid 1px #aaa; height: 98%;">
				...
				<div style="padding: 2px; margin: 2px;">
					附件上传：<a class="mini-button" id="filebtn">点击打开上传页面</a>
			...
			<fieldset style="border: solid 1px #aaa; height: 98%; display:none">
				<legend>退回原因</legend>
				<div><input id="results"  name="results"  readonly="readonly" class="mini-textarea" style="width:700px;height:100px;"  vtype="maxLength:900" /></div>
				<div>
				退回附件:
					<div id="datagrid3" dataField="datas" class="mini-datagrid"
							style="width: 700px; height: 180px;" sortMode="client"
							allowUnselect="false" oncellclick="" onrowdblclick=""
							onselectionchanged="" onload=""
	...
	<div class="mini-toolbar" style="text-align: center; padding-top: 10px; padding-bottom: 10px; margin-bottom: -5px;"borderStyle="border-left:0;border-bottom:0;border-right:0;">
		<a class="mini-button" onclick="onCancel()" style="margin-right: 20px;" iconCls="icon-close"> 取消 </a> 
	</div>
	<script type="text/javascript">
        ...
        grid2.load();
        var grid3 = mini.get("datagrid3");	//获取datagrid2标签
        grid3.load();
		...
		function saveJson() {
			//保存
			var urlStr = "<%=root %>/djbapprove/save?pageType=edit";
			var o = form.getData(); 
