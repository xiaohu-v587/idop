...
<html>
	...
	<body> 
		<div class="mini-fit">
			<div id="datagrid1" class="mini-datagrid" idField='mid' style="width:100%;margin:1% 0;border-right:0;height:95%"
...
<script type="text/javascript">
	...
	function setData(data) {
		...
		$G.postByAjax({rid:data.rid,uid:data.uid,orgid:orgid},"<%=root%>/manualReport/getTableByUids",ajaxConf);
	}
