...
<body style="overflow: auto;">
					...
					<table>
						<tr>
							...
							<td align="center"><input id="monitor_name" width="200px" name="monitor_name" class="mini-combobox"
								url="<%=root%>/personMonitor/getMonitorName" multiSelect="false" allowInput="false" oncloseclick="onCloseClick" 
	...
	<div class="content_box" style="height: 50%; width: 49%; border-top: 1px #e7ebef solid;" id="rpt3">
		...
		<div class="mini-fit">
			<div id="datagrid1" dataField="data" class="mini-datagrid" style="width: 100%; height: 98%;" sortMode="client"
				emptyText="没有对应的记录" allowUnselect="false" url="<%=root%>/personMonitor/getList" multiSelect="false"
				...
				<div property="columns">
					...
					<div field="ehr_no" headerAlign="center" width="100" allowMove="false" allowSort="true" align="center">EHR号
					</div>
					<div field="teller_no" headerAlign="center" width="100" allowMove="false" allowSort="true" align="center">人员名称
					</div>
	...
	<div class="content_box" style="height: 50%; width: 49%; border-top: 1px #e7ebef solid;" id="rpt6">
		<div align="center" style="font-size: 16px; font-weight: bold; height: 10%; margin-top: 1%">近三期均被监测的人员
		</div>
		<div class="mini-fit">
			<div id="datagrid2" dataField="data" class="mini-datagrid" style="width: 100%; height: 98%;" sortMode="client"
				emptyText="没有对应的记录" allowUnselect="false" url="<%=root%>/personMonitor/getPerson" multiSelect="false"
				allowCellSelect="false" allowResize="false" autoEscape="false"
				allowResizeColumn="false" showEmptyText="true" allowMove="false">
				<div property="columns">
...
//监测条件下拉框清空
	...
	function onCloseClick(e) {
  	...
  	function detail(){
    	...
    	if(monitor_name!=""&&monitor_date!=""){
            ...
            var url="<%=root%>/personMonitor/toDetail";
	...
	function findBaseDate(data,callback){
  		...
  		$G.ajax({
  			url:"<%=root%>/personMonitor/getGegendData",
    	  	data:data,
    	  	cache: false,
	...
	function findPatternMap(data){
		...
		option4.title={text:'数量最多的10个人员',x:'center',y:'10px'};
        ...
        option5.title={text:'监测人员数',x:'center',y:'10px'};
