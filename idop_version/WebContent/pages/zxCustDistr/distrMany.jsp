		...
		<form id="form1" method="post">
        	...
        	<input name="claim_props" class="nui-hidden"/>
           	<table style="table-layout: fixed;padding-top: 20px;" id="detailTable"  width="100%">
				...
				<tr>
                   	<td style="padding-left: 40px;" colspan="4">批量可分配比例最大值：<span id="claim_prop_max"></span>%</td>
				</tr>
				<tr>                                                                                       
					<td align="right">                                                              
...
<script type="text/javascript">
	...
	function setData(data){
		...
		var ids=infos.ids;
		toProp = infos.claim_prop_max.replace("%","");
	...
	function save(){
    	...
    	var urlStr = "<%=root%>/zxCustDistr/distManySave";
