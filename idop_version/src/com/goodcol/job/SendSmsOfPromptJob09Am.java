...
public class SendSmsOfPromptJob09Am extends OuartzJob{
	private static final String sm_job = "IdopSendSmsOfPromptJob09Am";
	@Override
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try {
			...
			String old=BolusDate.addDate(now, -1);
			String nowdate=now+"090000";
			String olddate=old+"160000";
