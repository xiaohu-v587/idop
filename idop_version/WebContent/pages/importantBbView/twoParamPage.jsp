...
function branch_choice()
	{
	 // var id=document.getElementById("id").value;
	  ...
	  var querystr2="http://"+ipaddress+"/WebReport/ReportServer?reportlet=/idop/"+sondata+"&__bypagesize__=false&querdate="+begindate+"&enddate="+begindate+"&branch_no="+branch_no+"&brno="+brno;
