...
<html>
	...
	<body>
			<div class="mini-fit" style="padding:8%;">
	...
	<div class="nui-toolbar"
		...
		borderStyle="border-left:0;border-bottom:0;border-right:0;">
			<a class="nui-button" iconCls="icon-save" onclick="ajaxFileUpload()">上传</a> <a
...
<!-- 				 <div> -->
<!-- 				           文件：<input class="mini-htmlfile" name="upload_file"  id="file1" style="width:300px;"/> -->
...
<script type="text/javascript">
		...
		function ajaxFileUpload() {
		        ...
		        $.ajaxFileUpload({
		            url: '<%=root%>/pccm_notice/saveFile?id=${id}',                 //用于文件上传的服务器端请求地址
		            ...
		            {
		            	if(data=="0000"){
		            		$G.alert("上传成功","提示",function(){
		            			$G.closemodaldialog("ok");
		            		});
		            	}
						if(data=="9999"){
							$G.alert("上传失败","提示",function(){
		            			$G.closemodaldialog("ok");
		            		});
		            	}
