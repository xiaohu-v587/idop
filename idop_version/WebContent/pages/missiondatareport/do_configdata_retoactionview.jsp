...
<body>
 ...
 <script type="text/javascript">
	...
	function loadData(pageIndex){
		...
		$G.postByAjax({pageIndex: pageIndex,pageSize: page.pageSize,id:'<%=request.getAttribute("id") %>',type:'<%=request.getAttribute("type") %>'},"<%=root%>/missiondatareport/getRetoactionInfo",ajaxConf);
	}
