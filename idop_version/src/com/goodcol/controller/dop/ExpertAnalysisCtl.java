...
@RouteBind(path = "/expertAnalysis")
@Before({ManagerPowerInterceptor.class})
public class ExpertAnalysisCtl extends BaseCtl{
...
//		String resid = "I40280e81016368f168f13b8801636972c31f0501";//后续数据库进行查询
	...
	public void getPageName(){
		...
		String sql="";
			sql = "select id,page from dop_expert_config where module=? and dict ='0' order by createtime asc";
