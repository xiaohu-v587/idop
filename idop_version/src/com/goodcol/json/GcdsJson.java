...
import com.goodcol.plugin.activerecord.Model;
...
public class GcdsJson extends Json {
	...
	public static void setDefaultConvertDepth(int defaultConvertDepth) {
		...
		GcdsJson.defaultConvertDepth = defaultConvertDepth;
	}
	
	public GcdsJson setConvertDepth(int convertDepth) {
		if (convertDepth < 2) {
	...
	public GcdsJson setTimestampPattern(String timestampPattern) {
	...
	public static GcdsJson getJson() {
		return new GcdsJson();
	}
	...
	protected String otherToJson(Object value, int depth) {
		...
		if (value instanceof Model) {
			Map map = com.goodcol.plugin.activerecord.CPI.getAttrs((Model)value);
	...
	public <T> T parse(String jsonString, Class<T> type) {
		throw new RuntimeException("gcds " + com.goodcol.core.Const.GCDS_VERSION + 
