 ...
 * FileRender.
 */
public class MyFileRender extends com.goodcol.core.render.Render {
	...
	public MyFileRender(File file, String newFileName) {
		if (file == null) {
	...
	public void render() {
		...
		response.setHeader("Content-disposition", "attachment; filename=" + encodeFileName(newFileName));
        String contentType = Gcds.me().getServletContext().getMimeType(file.getName());
