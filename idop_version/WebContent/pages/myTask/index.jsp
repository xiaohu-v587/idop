...
<html>
	...
	<body>
		<div id="panel1" class="nui-panel" title="我的任务" style="width:100%;height:131px;" showToolbar="false" showCollapseButton="false"
			...
			<div class="nui-fit">
		    	<div id="datagrid1" class="nui-datagrid" url="<%=root%>/myTask/list" style="width: 100%;height: 100%;"
			        ...
			        <div property="columns">            
			        	...
			        	<!-- <div field="suspended" renderer="onSuspendedRenderer"   allowSort="true" headerAlign="center" align="center" >流程状态</div> -->
...
<script type="text/javascript">
	...
	function add() {
        ...
        $G.showmodaldialog("定义新的任务定义", url, 500, 250, bizParams, function(action){
	    	 grid.reload();
	    });
	}
		...
		if(row){
			$G.GcdsConfirm("确定执行？", "提示", function(action) {
				if (action == 'ok') {
        			...
        			if(!row.suspended)
        				state = 'suspend';
                	$G.postByAjax({"state":state,"processinstanceid":row.processinstanceid}, "<%=root%>/processinstance/updateState", ajaxConf);
