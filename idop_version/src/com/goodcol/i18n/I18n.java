 ...
 * <p>
 * Example:<br>
 * 1: Create resource file "demo_zh_CN.properties" content with: msg=你好  ! 你好{0}! <br>
 *    Create resource file "demo_en_US.properties" content with: msg=Hello  ! Hello {0}! <br><br>
 *    
 * 2: Res res = I18n.use("demo", "zh_CN");<br>
 *    res.get("msg");				// return value: 你好  ! 你好{0}!<br>
 *    res.format("msg", "詹波");		// return value: 你好  ! 你好詹波!<br><br>
 *    
 *    res = I18n.use("demo", "en_US");<br>
 *    res.get("msg");				// return value: Hello  ! Hello{0}!<br>
 *    res.format("msg", "james");	// return value: Hello  ! Hello James!<br>
 * </p>
 */
public class I18n {
