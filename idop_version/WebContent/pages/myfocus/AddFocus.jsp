              			...
              			<tr>
			                ...
			                <td colspan="1">
			                	<input class="mini-combobox"  width="170px;"  nullItemText="请选择..." emptyText="请选择..."  url="<%=root%>/param/getDict?key=dop_ywtype" 
			           	 				id="busi_module" name="busi_module"   onvaluechanged="onBusiModule" valueField="val"  required="true" textField="remark"></input>
			                </td>
              			</tr>
			            <tr>
    	...
    	<div showCollapseButton="false" style="border: 0;">
      	...
      	<div class="mini-fit">
			<div id="datagrid1" dataField="data" class="mini-datagrid" style="width: 100%; height: 98%;" sortMode="client" emptyText="没有对应的记录"
				allowUnselect="false" url="<%=root%>/myfocus/getList" multiSelect="true" allowCellSelect="false"  autoEscape="false"
				  showEmptyText="true">
				<div property="columns">
		            <div type="checkcolumn" ></div>
