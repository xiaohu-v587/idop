	...
	<body>
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="data" class="mini-datagrid" style="width:100%;height:100%;" sortMode="client" allowUnselect="false"
				oncellclick=""  onselectionchanged=""  url="<%=root%>/manualReport/getReceives"
				...
				<div property="columns">
			        ...
			        <div field="uname" width="100"  allowSort="true" headerAlign="center" align="left">报表发送对象</div>
			        <div field="start_time" allowSort="true" headerAlign="center" align="left" renderer="dateformat">任务开始时间</div>
			        <div field="end_time" allowSort="true" headerAlign="center" align="left" renderer="dateformat">任务结束时间</div>
                    <div field="time" allowSort="true" headerAlign="center" align="right">任务时长</div>
				</div>
			</div>  
		</div>
	</body>
