...
<body>
	<div class="main_box" >
    	<div class="nav_box">
            <div class="nav" >
            	 <span class="border_r clickclass" name="jgtp" url="<%=root %>/opPortrait/indexOrg?orgnum=<%=request.getAttribute("org") %>">
                	机构图谱
                </span>
            	<span class="clickclass" name="rytp" url="<%=root %>/opPortrait/indexPerson?orgnum=<%=request.getAttribute("org") %>">
                	人员图谱
                </span>
            </div>
        </div>
        <div class="content_box" >
        	<iframe id="main" class="iframe_c" frameborder="0" src="<%=root %>/opPortrait/indexOrg?orgnum=<%=request.getAttribute("org") %>">
        	</iframe>
        </div>
    </div>
</body>
