...
import com.goodcol.plugin.activerecord.cache.ICache;
import com.goodcol.plugin.activerecord.dialect.Dialect;
import com.goodcol.plugin.activerecord.sql.SqlKit;
...
public class ActiveRecordPlugin implements IPlugin {
	...
	public static void useAsDataTransfer(IContainerFactory containerFactory) {
		useAsDataTransfer(new com.goodcol.plugin.activerecord.dialect.MysqlDialect(), containerFactory, new com.goodcol.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer(Dialect dialect, IContainerFactory containerFactory) {
		useAsDataTransfer(dialect, containerFactory, new com.goodcol.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer(Dialect dialect) {
		useAsDataTransfer(dialect, IContainerFactory.defaultContainerFactory, new com.goodcol.plugin.activerecord.cache.EhCache());
	}
	...
	public static void useAsDataTransfer() {
		useAsDataTransfer(new com.goodcol.plugin.activerecord.dialect.MysqlDialect(), IContainerFactory.defaultContainerFactory, new com.goodcol.plugin.activerecord.cache.EhCache());
	}
}
