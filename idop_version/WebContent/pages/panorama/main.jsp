...
<body>
	<div class="main_box" >
    	<div class="nav_box">
            <div class="nav" >
            	<span class="border_r clickclass" name="yyqj" url="<%=root %>/panorama/indexYq?orgnum=<%=request.getAttribute("org") %>">
                	运营全景视图
                </span>
            	<span class="border_r clickclass" name="jgwd" url="<%=root %>/panorama/indexJw?orgid=<%=request.getAttribute("org") %>">
                	机构维度
                </span>
            	<span class="border_r clickclass" name="rywd" url="<%=root %>/panorama/indexRw?orgnum=<%=request.getAttribute("org") %>">
                	人员维度
                </span>
            	<span class="clickclass" name="yjxi" url="<%=root %>/panorama/indexYj?orgnum=<%=request.getAttribute("org") %>">
                	预警信息
                </span>
            </div>
        </div>
        <div class="content_box" >
        	<iframe id="main" class="iframe_c" frameborder="0" src="<%=root %>/panorama/indexYq?orgnum=<%=request.getAttribute("org") %>">
        	</iframe>
        </div>
    </div>
</body>
