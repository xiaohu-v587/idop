	...
	<body>
		...
		<div class="nui-fit">
			<div id="datagrid1" dataField="data" class="mini-datagrid" style="width:100%;height:100%;" 
				sortMode="client" allowUnselect="false" url="<%=root%>/manualReport/getReceivesOfsp" autoEscape="false">
				<div property="columns">
			        ...
			        <div field="orgid" allowSort="true" headerAlign="center" align="center" visible="false">报送对象id</div>
...
<script type="text/javascript">
	...
	function view(index){
		var row = grid.getRow(index);
		var url = "<%=root%>/manualReport/views";
