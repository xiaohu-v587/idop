package com.goodcol.plugin.redis;
...
import com.goodcol.plugin.redis.serializer.FstSerializer;
import com.goodcol.plugin.redis.serializer.ISerializer;

/**
 * RedisPlugin.
 * RedisPlugin 支持多个 Redis 服务端，只需要创建多个 RedisPlugin 对象
 * 对应这多个不同的 Redis 服务端即可。也支持多个 RedisPlugin 对象对应同一
 * Redis 服务的不同 database，具体例子见   手册
 */
